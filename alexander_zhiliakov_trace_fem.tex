...
We solve the surface C--H problem for the mesh level 6 and $\epsilon = 10^{-2}$.

\begin{figure}[H]
	\centering
	\begin{subfigure}{.5\linewidth}
		\centering
		\includegraphicsw{ch6_perimeter.pdf}
	\end{subfigure}%
	\begin{subfigure}{.5\linewidth}
		\centering\small
		...
		\end{tabular}
	\end{subfigure}%
	\caption{Left: Diffuse interface perimeter estimate~$\epsilon\,\|\nabla_\Gamma\,c_h\|^2_{\LTwoSpace}$ as a function of time, $t \in \lbrack 0.01, 10 \rbrack$, for 30\%\::\:70\% mixture ($0.300364 \le \frac{\int_\Gamma c_h \diff{s}}{\int_\Gamma \diff{s}} \le 0.30037$). Right: Perimeter values and number of rafts}
