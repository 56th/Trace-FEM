...
\begin{figure}[H]
	\centering
	\includegraphicsw[.7]{kh_kinetic_energy.pdf}
	\caption{Kinetic energy as a function of time for~$h \in \{1.04\times 10^{-1}, 5.21\times 10^{-2}, 2.6\times 10^{-2}\}$ \AZ{Add plot markers so that curves are distinguishable in gray scale}}
...
\begin{figure}[H]
	...
	\begin{subfigure}{.5\linewidth}
		...
		\end{tabular}
	\end{subfigure}%
	\caption{Left: $\LTwoSpace{}$-norm of the surface divergence of~$\vect u_h$ as a function of time for~$h \in \{1.04\times 10^{-1}, 5.21\times 10^{-2}, 2.6\times 10^{-2}\}$. Right: Minimum, maximum, and mean values over~$t \in \lbrack 0, T = 20\rbrack$ of $\LTwoSpace{}$-norm of the surface divergence of~$\vect u_h$ \AZ{Add plot markers so that curves are distinguishable in gray scale}}
	\label{fig:kh:div}		
\end{figure}
