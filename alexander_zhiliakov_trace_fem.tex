...
\begin{figure}[H]
	\centering
	\includegraphicsw[.45]{kh_kinetic_energy.pdf}
	\caption{Kinetic energy~$\frac 12 \|\vect u_h\|^2_{\LTwoSpace}$ as a function of time for~$h \in \{1.04\times 10^{-1}, 5.21\times 10^{-2}, 2.6\times 10^{-2}\}$}
